...
class ResettingController extends Controller
{
    ...
    public function request(Request $request, Mailer $mailer, TokenGeneratorInterface $tokenGenerator)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
           ...
           $mailer->sendMessage('mailtrap@example.com', $user->getEmail(), 'Password Reset', $bodyMail);
    
            $request->getSession()->getFlashBag()->add('success', "check your inbox to reset your password.");
