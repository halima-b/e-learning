...
{
    /**
     * @Route("/profile-edit", name="profile_edit_admin")
     */
    ...
    /**
     * @Route("/pass-edit", name="password_edit_admin")
     */
    ...
    if ($form->isSubmitted() && $form->isValid()) {
     ...
     /**
     * @Route("/photo-edit", name="photo_edit_admin")
     */
    ...
    if ($form->isSubmitted() && $form->isValid()) {
       ...
       /**
     * @Route("/instructor/profile-edit", name="profile_edit")
     */
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        return $this->render('profile_instructor/edit.html.twig', [
            'controller_name' => 'ProfileController','EditProfileForm' => $form->createView()
        ]);
    }
    ...
    /**
     * @Route("/instructor/pass-edit", name="password_edit")
     */
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        return $this->render('profile_instructor/password.html.twig', [
            'controller_name' => 'ProfileController','EditPasswordForm' => $form->createView()
        ]);
    }
     /**
     * @Route("/instructor/photo-edit", name="photo_edit")
     */
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        return $this->render('profile_instructor/editPhoto.html.twig', [
            'controller_name' => 'ProfileController','EditPhotoForm' => $form->createView()
        ]);
    }
}
